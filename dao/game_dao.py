...
import enum
from sqlalchemy import Table, Column, Integer, String, ForeignKey, Enum, select,
...
class BattlefieldEntity(Base):
    ...
    vessels = relationship("VesselEntity",
...
class VesselEntity(Base):
    ...
    battelfield = relationship("BattlefieldEntity", back_populates="vessels")
